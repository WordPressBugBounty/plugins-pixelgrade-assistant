...
if ( ! function_exists( 'pixassist_register_styles_tab' ) ) {
	...
	function pixassist_register_styles_tab( $tabs ) {
		...
		$tabs[] = array(
			'id'         => 'styles',
			'label'      => esc_html__( 'Design System', 'pixelgrade-assistant' ),
...
if ( ! function_exists( 'pixassist_get_styles_data' ) ) {
	...
	function pixassist_get_styles_data() {
		...
		$data = array(
			'copy'          => array(
				'title'       => esc_html__( 'Your Site Design System', 'pixelgrade-assistant' ),
				'intro'       => esc_html__( 'Style Manager controls the visual decisions that keep your theme and blocks working together.', 'pixelgrade-assistant' ),
				'description' => esc_html__( 'Use these Style Manager sections to refine the visual foundations your site exposes.', 'pixelgrade-assistant' ),
			),
			'primaryAction' => array(
				'id'    => 'style-manager',
...
if ( ! function_exists( 'pixassist_get_styles_destinations' ) ) {
	...
	function pixassist_get_styles_destinations( $style_url, $plus_status = array() ) {
		$destinations = array(
			array(
				'id'          => 'colors',
				'title'       => esc_html__( 'Colors', 'pixelgrade-assistant' ),
				'description' => esc_html__( 'Adjust the palette and contrast choices that shape your site.', 'pixelgrade-assistant' ),
				'actionLabel' => esc_html__( 'Edit the Color System', 'pixelgrade-assistant' ),
				...
				'imageAlt'    => esc_attr__( 'Color System preview board with generated color roles.', 'pixelgrade-assistant' ),
			),
			array(
				'id'          => 'typography',
				'title'       => esc_html__( 'Typography', 'pixelgrade-assistant' ),
				'description' => esc_html__( 'Tune the font system for headings, body text, and interface details.', 'pixelgrade-assistant' ),
				'actionLabel' => esc_html__( 'Manage Typography', 'pixelgrade-assistant' ),
				...
				'imageAlt'    => esc_attr__( 'Typography preview board with system font roles.', 'pixelgrade-assistant' ),
			),
			array(
				'id'          => 'spacing',
				'title'       => esc_html__( 'Spacing', 'pixelgrade-assistant' ),
				'description' => esc_html__( 'Refine the rhythm and layout spacing that make pages feel balanced.', 'pixelgrade-assistant' ),
				'actionLabel' => esc_html__( 'Adjust Spacing', 'pixelgrade-assistant' ),
				...
				'imageAlt'    => esc_attr__( 'Spacing and rhythm preview board with layout measurements.', 'pixelgrade-assistant' ),
			),
		);
