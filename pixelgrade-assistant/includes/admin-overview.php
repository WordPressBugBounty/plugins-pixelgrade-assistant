...
if ( ! function_exists( 'pixassist_get_onboarding_steps' ) ) {
	...
	function pixassist_get_onboarding_steps( $facts ) {
		...
		$steps = array(
			array(
				'id'          => 'account',
				'title'       => esc_html__( 'Connect your account', 'pixelgrade_assistant' ),
				'description' => esc_html__( 'Connect a free pixelgrade.com account for support and updates. Optional.', 'pixelgrade_assistant' ),
		...
		if ( ! empty( $facts['demos_exist'] ) ) {
			$steps[] = array(
				'id'          => 'starter',
				'title'       => esc_html__( 'Pick a starter site', 'pixelgrade_assistant' ),
